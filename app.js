document.addEventListener("DOMContentLoaded", () => {
  ...
  let timerId;
  let score = 0;
  const colors = ["blue", "yellow", "aqua", "purple", "lime", "red", "orange"];
  ...
  //assign movement with keycodes to functions
  function control(e) {
    if (e.keyCode === 37) {
      moveLeft();
  ...
  //rotate the tetromino by going through its array with all rotations
  function rotate() {
    undraw();
    currentRotation++;
  ...
  //the tetrominoes wthout the rotations
  ...
  //display the shape in the up next
